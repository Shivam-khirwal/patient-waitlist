...
• Walkthrough of Key Visuals:<br>
   ...
   Summary<br>
   • Key KPIs (Top Left)-Latest Month Waitlist: 704k Prevoius year latest month waitlist: 624k <br>
   • Case Type - Filter with Types of cases<br>
   • Speciality - Filter With Type of doctor speciality<br>
   • Date Filter - We can select the exact date from 2018-2021<br>
   • Case Type split - A doughnut With inpatient , Day case , outpatient <br>
   • Average/Median - A slicer for a whole chart filters out based on these slicer by avg/med patient waitlist in the dashboard.<br>
   • Time Band Vs Age profile - patients based in a column chart by their age profile.<br>
   • Top 5 Speciality - A row card with top five speciality.<br>
   • Monthly Trend Analysis (Day case , inpatient vs outpatient) - Line graphs representing the data from 2018-21.<br>
